...
var searchLibraryTool = new BetaRunnableTool
{
    Name = "search_library",
        ...
        InputSchema = new InputSchema
        {
            Properties = new Dictionary<string, JsonElement>
            {
                ...
                ["mood"] = JsonSerializer.SerializeToElement(
                    new { type = "string", description = "Mood to search for, for example Funny." }
                ),
                ["maxRuntimeMinutes"] = JsonSerializer.SerializeToElement(
                    new { type = "integer", description = "Maximum allowed runtime in minutes." }
                ),
...
var getTitleDetailsTool = new BetaRunnableTool
{
...
var addToWatchlistTool = new BetaRunnableTool
{
...
var runner = client.Beta.Messages.ToolRunner(
    new MessageCreateParams
    {
        ...
        [
            new()
            {
                ...
                Then add it to my Tonight watchlist and explain your choice.
    ...
    [searchLibraryTool, getTitleDetailsTool, addToWatchlistTool]
);
...
await foreach (var message in runner)
{
    ...
    Console.WriteLine();
    Console.WriteLine($"========== MODEL / TOOL CYCLE {cycle} ==========");
